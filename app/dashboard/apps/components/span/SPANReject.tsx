...
import TableContentSpanReject from "./TableContentSPANReject";


export default function SPANReject() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-semibold">
        SPAN - Patching Reject SPAN Transactions
      </h1>

      <div className="card bg-base-100 shadow">
        <div className="card-body">
          <p className="text-sm text-gray-500">
            Patching Reject SPAN Transactions
          </p>
          <TableContentSpanReject
