...
import { spanRejectDummyData } from "@/app/constant/dummyData";
import TableContentSPANBPDRiau from "./TableContentSPANBPDRiau";


export default function SPANBPDRiau() {
...
const handlerSelectAllRow = (e: React.ChangeEvent<HTMLInputElement>) => {
  if (e.target.checked) {
    ...
    const allSelected = spanRejectDummyData.map((item) => item.DocumentNumber);
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-semibold">
        SPAN - Patching SPAN BPD Riau Transactions
      </h1>

      <div className="card bg-base-100 shadow">
        <div className="card-body">
          <p className="text-sm text-gray-500">
            Patching SPAN BPD Riau Transactions
          </p>
          <TableContentSPANBPDRiau
            data={spanRejectDummyData}
