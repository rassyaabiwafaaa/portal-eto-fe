...
import TableContentBoValas from "./TableContentBoValas";


export default function SPANBOValas() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-semibold">
        SPAN - Patching BO Valas Transactions
      </h1>

      <div className="card bg-base-100 shadow">
        <div className="card-body">
          <p className="text-sm text-gray-500">
            Patching BO Valas Transactions
          </p>
          <TableContentBoValas
