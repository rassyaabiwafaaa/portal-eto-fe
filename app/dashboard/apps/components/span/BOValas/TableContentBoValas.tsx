...
interface TableContentBoValasProps {
        data: any[];
        selectedRow: string[];
...
export default function TableContentBoValas({ data, selectedRow, handlerSelectedRow, handlerSelectAllRow }: TableContentBoValasProps) {
