...
interface TableContentInqVaProps {
        data: any[];
        selectedRow: string[];
...
export default function TableContentSpanReject({ data, selectedRow, handlerSelectedRow, handlerSelectAllRow }: TableContentInqVaProps) {
